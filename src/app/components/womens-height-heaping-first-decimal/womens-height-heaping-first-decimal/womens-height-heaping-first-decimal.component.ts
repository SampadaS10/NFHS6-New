...
@Component({
  selector: 'app-womens-height-heaping-first-decimal',
  templateUrl: './womens-height-heaping-first-decimal.component.html',
  styleUrls: ['./womens-height-heaping-first-decimal.component.scss']
})
export class WomensHeightHeapingFirstDecimalComponent{
  ...
  async getdata(){
     this.datalist = await lastValueFrom(this.householdService.getAllWomensHeightHeapingFirstDecimal());
...
exportPdf() {
    import('jspdf').then((jsPDF) => {
        import('jspdf-autotable').then((x) => {
            ...
            doc.save('womens-height-heaping-first-decimal.pdf');
        });
    });
}
...
exportExcel() {
    import('xlsx').then((xlsx) => {
        ...
        this.saveAsExcelFile(excelBuffer, 'womens-height-heaping-first-decimal_');
    });
}
