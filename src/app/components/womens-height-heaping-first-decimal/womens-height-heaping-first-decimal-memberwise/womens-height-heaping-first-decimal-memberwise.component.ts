...
@Component({
  selector: 'app-womens-height-heaping-first-decimal-memberwise',
  templateUrl: './womens-height-heaping-first-decimal-memberwise.component.html',
  styleUrls: ['./womens-height-heaping-first-decimal-memberwise.component.scss']
})
export class WomensHeightHeapingFirstDecimalMemberwiseComponent {
  ...
  async getdata(){
     this.datalist = await lastValueFrom(this.householdService.getAllWomensHeightHeapingFirstDecimalMemberwise(this.stateId,this.teamNo));
...
exportPdf() {
    import('jspdf').then((jsPDF) => {
        import('jspdf-autotable').then((x) => {
            ...
            doc.save('womens-height-heaping-first-decimal-memberwise.pdf');
        });
    });
}
...
exportExcel() {
    import('xlsx').then((xlsx) => {
        ...
        this.saveAsExcelFile(excelBuffer, 'womens-height-heaping-first-decimal-memberwise_');
    });
}
