...
@Component({
  selector: 'app-womens-height-heaping-first-decimal-teamwise',
  templateUrl: './womens-height-heaping-first-decimal-teamwise.component.html',
  styleUrls: ['./womens-height-heaping-first-decimal-teamwise.component.scss']
})
export class WomensHeightHeapingFirstDecimalTeamwiseComponent {
...
this.getdata();
  ...
  async getdata(){
     this.datalist = await lastValueFrom(this.householdService.getAllWomensHeightHeapingFirstDecimalTeamwise(this.stateId));
...
exportPdf() {
    import('jspdf').then((jsPDF) => {
        import('jspdf-autotable').then((x) => {
            ...
            doc.save('womens-height-heaping-first-decimal-teamwise.pdf');
        });
    });
}
...
exportExcel() {
    import('xlsx').then((xlsx) => {
        ...
        this.saveAsExcelFile(excelBuffer, 'womens-height-heaping-first-decimal-teamwise_');
    });
}
