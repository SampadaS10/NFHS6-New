...
@Component({
  selector: 'app-mens-height-heaping-first-decimal',
  templateUrl: './mens-height-heaping-first-decimal.component.html',
  styleUrls: ['./mens-height-heaping-first-decimal.component.scss']
})
export class MensHeightHeapingFirstDecimalComponent 
{
  ...
  async getdata(){
     this.datalist = await lastValueFrom(this.householdService.getAllMensHeightHeapingFirstDecimal());
...
exportPdf() {
    import('jspdf').then((jsPDF) => {
        import('jspdf-autotable').then((x) => {
            ...
            doc.save('mens-height-heaping-first-decimal.pdf');
        });
    });
}
...
exportExcel() {
    import('xlsx').then((xlsx) => {
        ...
        this.saveAsExcelFile(excelBuffer, 'mens-height-heaping-first-decimal_');
    });
}
