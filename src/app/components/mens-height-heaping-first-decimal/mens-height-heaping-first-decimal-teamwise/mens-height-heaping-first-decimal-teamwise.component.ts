...
@Component({
  selector: 'app-mens-height-heaping-first-decimal-teamwise',
  templateUrl: './mens-height-heaping-first-decimal-teamwise.component.html',
  styleUrls: ['./mens-height-heaping-first-decimal-teamwise.component.scss']
})
export class MensHeightHeapingFirstDecimalTeamwiseComponent 
{
...
this.getdata();
  ...
  async getdata(){
     this.datalist = await lastValueFrom(this.householdService.getAllMensHeightHeapingFirstDecimalTeamwise(this.stateId));
...
exportPdf() {
    import('jspdf').then((jsPDF) => {
        import('jspdf-autotable').then((x) => {
            ...
            doc.save('mens-height-heaping-first-decimal-teamwise.pdf');
        });
    });
}
...
exportExcel() {
    import('xlsx').then((xlsx) => {
        ...
        this.saveAsExcelFile(excelBuffer, 'mens-height-heaping-first-decimal-teamwise_');
    });
}
