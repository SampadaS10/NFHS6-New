...
@Component({
  selector: 'app-womens-weight-heaping-second-decimal-teamwise',
  templateUrl: './womens-weight-heaping-second-decimal-teamwise.component.html',
  styleUrls: ['./womens-weight-heaping-second-decimal-teamwise.component.scss']
})
export class WomensWeightHeapingSecondDecimalTeamwiseComponent {
...
this.getdata();
  ...
  async getdata(){
     this.datalist = await lastValueFrom(this.householdService.getAllWomensWeightHeapingSecondDecimalTeamwise(this.stateId));
...
exportPdf() {
    import('jspdf').then((jsPDF) => {
        import('jspdf-autotable').then((x) => {
            ...
            doc.save('womens-weight-heaping-second-decimal-teamwise.pdf');
        });
    });
}
...
exportExcel() {
    import('xlsx').then((xlsx) => {
        ...
        this.saveAsExcelFile(excelBuffer, 'womens-weight-heaping-second-decimal-teamwise-');
    });
}
