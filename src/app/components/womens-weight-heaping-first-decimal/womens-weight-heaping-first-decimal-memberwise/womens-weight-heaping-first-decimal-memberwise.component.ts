...
@Component({
  selector: 'app-womens-weight-heaping-first-decimal-memberwise',
  templateUrl: './womens-weight-heaping-first-decimal-memberwise.component.html',
  styleUrls: ['./womens-weight-heaping-first-decimal-memberwise.component.scss']
})
export class WomensWeightHeapingFirstDecimalMemberwiseComponent {
  ...
  async getdata(){
     this.datalist = await lastValueFrom(this.householdService.getAllWomensWeightHeapingFirstDecimalMemberwise(this.stateId,this.teamNo));
...
exportPdf() {
    import('jspdf').then((jsPDF) => {
        import('jspdf-autotable').then((x) => {
            ...
            doc.save('womens-weight-heaping-first-decimal-memberwise.pdf');
        });
    });
}
...
exportExcel() {
    import('xlsx').then((xlsx) => {
        ...
        this.saveAsExcelFile(excelBuffer, 'womens-weight-heaping-first-decimal-memberwise-');
    });
}
