...
@Component({
  selector: 'app-womens-weight-heaping-first-decimal-teamwise',
  templateUrl: './womens-weight-heaping-first-decimal-teamwise.component.html',
  styleUrls: ['./womens-weight-heaping-first-decimal-teamwise.component.scss']
})
export class WomensWeightHeapingFirstDecimalTeamwiseComponent {
...
this.getdata();
  ...
  async getdata(){
     this.datalist = await lastValueFrom(this.householdService.getAllWomensWeightHeapingFirstDecimalTeamwise(this.stateId));
...
exportPdf() {
    import('jspdf').then((jsPDF) => {
        import('jspdf-autotable').then((x) => {
            ...
            doc.save('womens-weight-heaping-first-decimal-teamwise.pdf');
        });
    });
}
...
exportExcel() {
    import('xlsx').then((xlsx) => {
        ...
        this.saveAsExcelFile(excelBuffer, 'womens-weight-heaping-first-decimal-teamwise-');
    });
}
