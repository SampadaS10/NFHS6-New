...
export class ChildrensWeightMemberwiseComponent 
{
  ...
  ngOnInit() {  
    ...
    this.cols = [                
      ...
      { field: 'measured', header: 'Measured [Result of weight measured]' },
      { field: 'childNotPresent', header: 'Child Not Present [Result of weight measured]' },
      { field: 'refused', header: 'Refused [Result of weight measured]' },
      { field: 'other', header: 'Other [Result of weight measured]' },
      { field: 'missing', header: 'Missing [Result of weight measured]' },
      { field: 'total', header: 'Total' },
      { field: 'numberOfChildren', header: 'Number Of Children' },
      { field: 'weightOutOfRange', header: 'Weight Out Of Range [Among children measured]' },
      { field: 'dateOfBirthIncomplete', header: 'dateOfBirthIncomplete [Among children measured]' },
      { field: 'childrenWithValidData', header: 'Children With Valid Data' },
      { field: 'weightForHeightZScoreOutOfRange', header: 'Height For Age Z Score Out Of Range' },
...
exportExcel() {
    import('xlsx').then((xlsx) => {
        ...
        this.saveAsExcelFile(excelBuffer, 'childrens-weight-memberwise_');
    });
}
